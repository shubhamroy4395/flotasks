...
import { 
  Focus, Play, Pause, RotateCcw, X, Bell, SkipForward, Settings, Music, ChevronDown, Zap, Clock, VolumeX, Volume2, Image, Check, Radio, DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, DropdownMenuLabel, DropdownMenuSeparator
} from "lucide-react";
                        ...
                        <DropdownMenuContent align="end" className="w-56">
                          ...
                          {LOFI_SONGS.map((song) => (
                            ...
                            >
                              ...
                              <span className={cn(
                                "flex-1 truncate",
                                selectedSong?.id === song.id && "font-medium text-primary"
                              )}>
                                {song.title}
                              </span>
                              {selectedSong?.id === song.id && (
              ...
              <TabsContent value="timer">
                <Card className={cn(
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {/* Song selection dropdown integration */}
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button 
                              variant="outline" 
                              className="w-full justify-between font-normal border-dashed bg-background/50 hover:bg-background/80"
                            >
                              {selectedSong ? (
